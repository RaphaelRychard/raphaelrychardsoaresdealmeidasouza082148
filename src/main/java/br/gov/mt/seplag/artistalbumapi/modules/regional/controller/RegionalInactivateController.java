...
public class RegionalInactivateController {
    ...
    @Operation(summary = "Inativar regional", description = "Inativa manualmente uma regional ativa no sistema")
    @ApiResponses(value = {@ApiResponse(responseCode = "204", description = "Regional inativada com sucesso"),})
