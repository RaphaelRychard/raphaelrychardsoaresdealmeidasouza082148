...
@Schema(description = "DTO para busca de artistas com paginação e ordenação")
public record SearchArtistRequestDTO(

        @NotBlank
        @Schema(description = "Nome do artista para busca", example = "Legião")
        String name,
